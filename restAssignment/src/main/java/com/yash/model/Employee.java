...
public class Employee  {
	...
	private Long id;
	 ...
	 @ApiModelProperty(notes = "name of Employee",name="name",required=true,value="test name")
	@NotBlank
	private String name;
	 
	 @ApiModelProperty(notes = "designtion of Employee",name="designtion",required=true,value="test designtio")
	@NotBlank
